...
namespace SdkNetCoreTests
{
    public class TestConfig
    {
        ...
        private static readonly string INTEGRATOR_KEY = "INTEGRATOR_KEY";
        private static readonly string INTEGRATOR_KEY_NO_CONSENT = "INTEGRATOR_KEY_NO_CONSENT";
        private static readonly string TEMPLATE_ID = "TEMPLATE_ID";
        private static readonly string BRAND_ID = "BRAND_ID";
        private static readonly string PRIVATE_KEY = "PRIVATE_KEY";
        private static readonly string PRIVATE_KEY_NO_CONSENT = "PRIVATE_KEY_NO_CONSENT";
            ...
            string returnUrl = null)
        {
            ...
            string templateIdFromEnv = Environment.GetEnvironmentVariable(TEMPLATE_ID);
            string brandIdFromEnv = Environment.GetEnvironmentVariable(BRAND_ID);
            this.PrivateKey = Convert.FromBase64String(Environment.GetEnvironmentVariable(PRIVATE_KEY));
            this.PrivateKeyNoConsent = Environment.GetEnvironmentVariable(PRIVATE_KEY_NO_CONSENT);
